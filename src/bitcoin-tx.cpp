...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bte-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bte transaction") + "\n" +
              "  bte-tx [options] -create [commands]   " + _("Create hex-encoded bte transaction") + "\n" +
              "\n";
