...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BitcoinEssence/bitcoinessence>";
    const std::string URL_WEBSITE = "<https://www.bitcoinessence.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BitcoinEssence version %s\n", FormatFullVersion());
}
