...
VERSION=
commit=false
url=https://github.com/BitcoinEssence/bitcoinessence
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bitcoinessence, gitian-builder, gitian.sigs.bte, and bitcoinessence-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/BitcoinEssence/bitcoinessence
...
then
    ...
    git clone https://github.com/BitcoinEssence/gitian.sigs.bte.git
    git clone https://github.com/BitcoinEssence/bitcoinessence-detached-sigs.git
...
then
	...
	make -C ../bitcoinessence/depends download SOURCES_PATH=`pwd`/cache/common
	...
	popd
        ...
        if [[ $commitFiles = true ]]
        then
	    # Commit to gitian.sigs.bte repo
            echo ""
            echo "Committing ${VERSION} Unsigned Sigs"
            echo ""
            pushd gitian.sigs.bte
...
then
	...
	echo ""
	./bin/gverify -v -d ../gitian.sigs.bte/ -r ${VERSION}-linux ../bitcoinessence/contrib/gitian-descriptors/gitian-linux.yml
	# Windows
	echo ""
